<?php 
    ...
    $link = DBconnec();
    $solicitations = DBread($link, 'solicitacoes AS s, usuarios_comerciais AS u, solicitacoes_comerciais AS sa', "WHERE s.id_solicitacao = sa.id_solicitacao AND u.id = sa.id_usuario ORDER BY s.id_solicitacao ASC", 's.*, u.id AS id_usuario');
...
<table>
	...
	?>
		<tr>
			<td><?php echo ($solicitations[$i]['id_solicitacao']+6000) ?></td>
			<td><?php echo ($solicitations[$i]['id_usuario']+600) ?></td>
